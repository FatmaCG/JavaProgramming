...
public class ReplaceAll {
    public static void main(String[] args) {
        ...
        String[] arrS={"Ali","Fatma","Meryem","Meltem","Rana","Rana"};
        arrS=replaceAll(arrS,"Rana","Berra");
...
/*2. RecplaceAll Task:
		...
		integer newElement. The method replaces all the element of the array that matching with the given old element with the given new element, and returns the new array.
			Ex:
